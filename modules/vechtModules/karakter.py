...
def SelectieScherm():
    ...
    karakter1 = loadImage("./assets/images/karakters/karakter1.png")
    imageMode(CENTER)
    image(karakter1, 196, 135, 170, 170)
    karakter2 = loadImage("./assets/images/karakters/Annotation 2019-06-05 192923.png")
    imageMode(CENTER)
    image(karakter2, 401, 135, 170, 170)
    karakter3 = loadImage("./assets/images/karakters/DM1KgmyUMAEOieM.jpg")
    imageMode(CENTER)
    image(karakter3, 606, 135, 170, 170)
    karakter4 = loadImage("./assets/images/karakters/Annotation 2019-06-12 2133075 (2).png")
    imageMode(CENTER)
    image(karakter4, 196, 343, 170, 170)
    karakter5 = loadImage("./assets/images/karakters/1570067242000.jpg")
    imageMode(CENTER)
    image(karakter5, 400, 343, 170, 170)
    karakter6 = loadImage("./assets/images/karakters/4 (2).png")
    imageMode(CENTER)
